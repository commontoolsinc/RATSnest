...
echo ""
echo "=================================================="
echo "Next Steps: Extract MRTD for Policy"
echo "=================================================="
echo ""
echo "1. Wait 30 seconds for VM to boot and generate first TDX quote"
echo ""
echo "2. Extract MRTD from console output:"
echo "   make extract-mrtd"
echo ""
echo "   Or manually:"
echo "   gcloud compute instances get-serial-port-output $INSTANCE_NAME --zone=$GCP_ZONE | grep -A 5 'MRTD VALUE'"
echo ""
echo "3. Update shared/policy.ts with the MRTD value"
echo ""
echo "4. Rebuild and redeploy with strict policy:"
...
echo "View logs:"
echo "  make logs"
echo "  make console-output  # Full console output"
echo ""
echo "Note: No SSH access - use serial console to view logs"
echo ""
